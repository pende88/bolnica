<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PlaniranjeTerapije.aspx.cs" Inherits="BolnicaClient.Doktor.PlaniranjeTerapije" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            <fieldset>
                <legend>Odabir terapije</legend>



                <asp:TextBox ID="txtDoktor" runat="server" Enabled="false"></asp:TextBox>

                <asp:TextBox ID="txtPacijent" runat="server" Enabled="false"></asp:TextBox>
            ...
            <fieldset>
                <legend>Terapije</legend>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList CssClass="btn btn-default" ID="ddlTerapija" runat="server" AppendDataBoundItems="true" 
                            AutoPostBack="true" DataValueField="IDTerapija" 
                            DataTextField="Naziv"
                            OnSelectedIndexChanged="ddlTerapija_SelectedIndexChanged">
                            <Items>
